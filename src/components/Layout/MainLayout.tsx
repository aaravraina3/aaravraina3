    ...
    return (
        <div className="relative w-screen h-screen bg-black overflow-hidden flex flex-col md:flex-row">
            ...
            <div className="absolute inset-0 pointer-events-none z-10">
                <Persona activeSection={activeSection} />
            </div>
            ...
            <div className={`w-full md:w-3/4 h-full relative z-20 md:z-20 flex items-center p-4 md:pl-4 md:pr-20 transition-all duration-700 ${activeSection === 'about' ? 'md:translate-x-12' : 'translate-x-0'} ${showMobileContent ? 'flex' : 'hidden md:flex'}`}>
                ...
                <div className={`relative transition-all duration-700 ease-in-out w-full h-full md:w-4/5 md:h-2/3 ${activeSection === 'about' ? 'md:w-5/6 md:h-4/5' : ''} flex items-center justify-center`}>
                    <div className="w-full max-w-lg h-5/6 md:max-w-none md:h-full md:absolute md:inset-0 bg-black/50 backdrop-blur-sm md:bg-black/60 md:backdrop-blur-md border-2 border-white rounded-lg md:rounded-none md:-skew-x-12 md:transform md:origin-bottom-left overflow-hidden">
